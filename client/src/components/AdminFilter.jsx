...
const AdminFilter = ({ jobFilters, setJobFilters }) => {
  ...
  <label for="jobTitle" class="text-sm font-medium text-gray-800 text-nowrap">Job Title:</label>
  <input 
    type="text"
    id="jobTitle"
...
<div class="flex items-center gap-2 ">
  <label for="location" class="text-sm font-medium text-gray-800 text-nowrap">Location:</label>
  <input
    type="text"
    id="location"
...
<div class="flex items-center gap-2">
  <label for="jobType" class="text-sm font-medium text-gray-800 text-nowrap">Job Type:</label>
  <select id="jobType" class="border rounded-md p-2 w-[6vw]focus:outline-none focus:ring focus:border-blue-300 transition duration-300" onChange={handleInputChange}>
